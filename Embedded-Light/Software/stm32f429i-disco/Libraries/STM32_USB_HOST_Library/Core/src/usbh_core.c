...
//  LCD_DisplayStringLine(LCD_LINE_0,(uint8_t*)"Init 1");
  
  /* configure GPIO pin used for switching VBUS power */
  USB_OTG_BSP_ConfigVBUS(0);  
//  LCD_DisplayStringLine(LCD_LINE_1,(uint8_t*)"Init 2");
  
  /* Host de-initializations */
  USBH_DeInit(pdev, phost);
//  LCD_DisplayStringLine(LCD_LINE_2,(uint8_t*)"De-Init 3");
...
//  LCD_DisplayStringLine(LCD_LINE_3,(uint8_t*)"HCD Init");
