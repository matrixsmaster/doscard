...
#define DOS_DEFAULTTIME DOS_PackTime(LDB_DEFTIME_HR,LDB_DEFTIME_MN,LDB_DEFTIME_SC)
#define DOS_DEFAULTDATE DOS_PackDate(LDB_DEFDATE_YR,LDB_DEFDATE_MN,LDB_DEFDATE_DY)
